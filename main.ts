sprites.onOverlap(SpriteKind.Enemy, SpriteKind.Food, function (sprite, otherSprite) {
    ...
    mySprite2.setPosition(randint(5, 150), randint(5, 105))
    music.spooky.play()
})
...
let mySprite3 = sprites.create(img`
    ...
    ........................
    `, SpriteKind.Enemy)
mySprite3.setPosition(randint(5, 150), randint(5, 105))
mySprite3.follow(mySprite2, 40)
info.startCountdown(60)
forever(function () {
    for (let index = 0; index < 4; index++) {
        music.playMelody("F A E C5 A B C5 B ", 504)
    }
    for (let index = 0; index < 4; index++) {
        music.playMelody("E A E C5 A B C5 G ", 504)
    }
    for (let index = 0; index < 4; index++) {
        music.playMelody("D A E C5 A B C5 E ", 504)
    }
    for (let index = 0; index < 4; index++) {
        music.playMelody("C A E C5 A B C5 D ", 504)
    }
})
